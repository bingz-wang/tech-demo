package com.wbz.jasypt;

import org.jasypt.encryption.pbe.StandardPBEStringEncryptor;
import org.jasypt.encryption.pbe.config.EnvironmentPBEConfig;

/**
 * @author zengxianyun@jbinfo.cn
 * @date 2024/7/23
 */
public class JasyptUtil {
    ...
    public static void main(String[] args) {
        ...
        String encryptedStr = "FBbW/QJOcSrVDqJ0AyM33BQ5KUPslWODtPzv6he/urM=";
        String algorithm = PBE_ALGORITHMS_MD5_DES;
        String password = "budweiser";
        ...
        System.out.println("解密后的字符串：" + JasyptUtil.decrypt("FBbW/QJOcSrVDqJ0AyM33BQ5KUPslWODtPzv6he/urM=", algorithm, password));
    }
}
